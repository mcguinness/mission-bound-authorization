...
processes the agent spawns, provider-side model context, and the
inference API itself, stating for each whether it is mediated, excluded
by the isolation mechanism, or outside the claim. The enumeration is
