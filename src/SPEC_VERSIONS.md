...
| `draft-mcguinness-mission-runtime` (decision contract) | `02d53dd` | `services/pdp` | abstract decision inputs, staleness bound, permit properties | `services/pdp/test/{evaluate,evaluate-decision-inputs,evaluate-classification,evaluate-decision,evaluate-compromise-resistant}.test.ts` |
