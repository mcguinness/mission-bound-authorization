...
| `draft-mcguinness-oauth-mission-transaction-authorization` | `fe8ec59` (2026-08-20) | `services/access-request/src/index.ts` | `txn-authorization#challenge-redemption`, `#offline-verification` | `services/access-request/test/txn.test.ts` |
