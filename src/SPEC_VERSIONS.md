...
| `draft-mcguinness-oauth-mission-status` | `49fc10f` (2026-08-26) | `services/authorization-server` (kernel + adapters) | `status#legal-transitions`, `status#state-machine`, `status#mission-status-response`, `status#mission-status-anti-oracle`, `status#mission-status-errors`, `status#mission-status-authentication`, `status#idempotency`, `status#as-metadata`, `status#status-operational` | `services/authorization-server/test/{kernel,tracer}.test.ts` |
