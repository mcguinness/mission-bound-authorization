...
|---|---|---|
| `draft-mcguinness-mission-runtime` (Evaluation-Context Binding) | `278dd777` | #773 optional per-class extension: descriptor-bound authoritative context, persistent salt state, existing approval/operation binding preservation and verified/enforced distinction; implementation pending |
