...
| `draft-mcguinness-mission-orchestration` | `030426bf` (2026-08-25) | `packages/orchestration` + `packages/mission-core` (anchors `UNWIND_PLAN_TYP`) | `orchestration#reversibility`, `orchestration#unwind-plan`, `orchestration#unwind-plan-integrity`, `orchestration#state-change-behavior`, `orchestration#compensation`, `orchestration#compensation-authority`, `orchestration#orchestration-evidence` | `packages/orchestration/test/orchestration.test.ts` |
