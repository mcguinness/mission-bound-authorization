...
|---|---|---|
| `draft-mcguinness-mission-runtime` (Evaluation-Context Binding) | `a4f61e17` | #773 optional per-class extension: descriptor-bound authoritative context, persistent salt state, existing approval/operation binding preservation and verified/enforced distinction; implementation pending |
...
| `draft-mcguinness-mission-runtime-evidence` (evaluation-context projection) | `278dd777` | #773 context digest/descriptor, execution digest pair and target_drift; implementation pending, no claim enabled |
