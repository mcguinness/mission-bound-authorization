...
venue:
  ...
  latest: "https://mcguinness.github.io/draft-mcguinness-oauth-mission/draft-mcguinness-mission-aauth.html"
...
Mission lifecycle governs with revocation and expiry, and the Person
Server gates auth-token issuance on Mission state. The auth token
becomes a Mission-bound credential, so the family's governance,
enforcement, and evidence profiles compose credential-carried. This is
the third binding of the Mission model and the first to a non-OAuth
substrate.
