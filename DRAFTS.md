...
Conformance ledger (`conformance-manifest.json`): 724 requirement rows across 24 audited specs (242 tested, 78 partial, 401 todo, 3 blocked); 23 documents carry no rows in the audited set yet.
