...
Conformance ledger (`conformance-manifest.json`): 708 requirement rows across 24 audited specs (236 tested, 77 partial, 392 todo, 3 blocked); 23 documents carry no rows in the audited set yet.
