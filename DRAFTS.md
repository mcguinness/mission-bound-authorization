...
Conformance ledger (`conformance-manifest.json`): 695 requirement rows across 24 audited specs (195 tested, 72 partial, 425 todo, 3 blocked); 23 documents carry no rows in the audited set yet.
