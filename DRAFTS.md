...
Spec maturity: 0 candidate, 37 experimental, 4 sketch, 3 not applicable (guide documents; protocol maturity does not apply).
Conformance ledger (`conformance-manifest.json`): 590 requirement rows across 18 audited specs (142 tested, 54 partial, 391 todo, 3 blocked); 26 documents carry no rows in the audited set yet.
