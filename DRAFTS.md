...
Conformance ledger (`conformance-manifest.json`): 663 requirement rows across 22 audited specs (181 tested, 71 partial, 408 todo, 3 blocked); 24 documents carry no rows in the audited set yet.
