...
Conformance ledger (`conformance-manifest.json`): 723 requirement rows across 24 audited specs (199 tested, 71 partial, 450 todo, 3 blocked); 23 documents carry no rows in the audited set yet.
