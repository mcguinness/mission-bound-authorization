...
Conformance ledger (`conformance-manifest.json`): 643 requirement rows across 20 audited specs (173 tested, 67 partial, 400 todo, 3 blocked); 26 documents carry no rows in the audited set yet.
