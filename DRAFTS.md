...
Conformance ledger (`conformance-manifest.json`): 595 requirement rows across 18 audited specs (142 tested, 58 partial, 392 todo, 3 blocked); 26 documents carry no rows in the audited set yet.
