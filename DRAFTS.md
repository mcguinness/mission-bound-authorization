...
Conformance ledger (`conformance-manifest.json`): 705 requirement rows across 24 audited specs (193 tested, 71 partial, 438 todo, 3 blocked); 23 documents carry no rows in the audited set yet.
