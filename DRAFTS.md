...
Conformance ledger (`conformance-manifest.json`): 708 requirement rows across 24 audited specs (204 tested, 76 partial, 425 todo, 3 blocked); 23 documents carry no rows in the audited set yet.
