...
Conformance ledger (`conformance-manifest.json`): 622 requirement rows across 20 audited specs (156 tested, 61 partial, 402 todo, 3 blocked); 26 documents carry no rows in the audited set yet.
