...
Conformance ledger (`conformance-manifest.json`): 602 requirement rows across 18 audited specs (147 tested, 56 partial, 396 todo, 3 blocked); 26 documents carry no rows in the audited set yet.
