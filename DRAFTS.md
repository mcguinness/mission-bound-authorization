...
Conformance ledger (`conformance-manifest.json`): 693 requirement rows across 24 audited specs (197 tested, 70 partial, 423 todo, 3 blocked); 23 documents carry no rows in the audited set yet.
