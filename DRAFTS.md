...
Conformance ledger (`conformance-manifest.json`): 620 requirement rows across 20 audited specs (155 tested, 57 partial, 405 todo, 3 blocked); 26 documents carry no rows in the audited set yet.
