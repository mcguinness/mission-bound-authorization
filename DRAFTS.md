...
Conformance ledger (`conformance-manifest.json`): 724 requirement rows across 24 audited specs (238 tested, 77 partial, 406 todo, 3 blocked); 23 documents carry no rows in the audited set yet.
