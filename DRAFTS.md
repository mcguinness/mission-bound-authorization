...
Conformance ledger (`conformance-manifest.json`): 707 requirement rows across 24 audited specs (199 tested, 73 partial, 432 todo, 3 blocked); 23 documents carry no rows in the audited set yet.
