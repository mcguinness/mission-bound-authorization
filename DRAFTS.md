...
Conformance ledger (`conformance-manifest.json`): 644 requirement rows across 20 audited specs (185 tested, 70 partial, 386 todo, 3 blocked); 26 documents carry no rows in the audited set yet.
