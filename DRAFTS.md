...
Conformance ledger (`conformance-manifest.json`): 643 requirement rows across 20 audited specs (181 tested, 71 partial, 388 todo, 3 blocked); 26 documents carry no rows in the audited set yet.
