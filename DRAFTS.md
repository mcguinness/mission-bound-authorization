...
Conformance ledger (`conformance-manifest.json`): 676 requirement rows across 22 audited specs (195 tested, 72 partial, 406 todo, 3 blocked); 25 documents carry no rows in the audited set yet.
