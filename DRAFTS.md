...
Conformance ledger (`conformance-manifest.json`): 674 requirement rows across 22 audited specs (195 tested, 72 partial, 404 todo, 3 blocked); 25 documents carry no rows in the audited set yet.
