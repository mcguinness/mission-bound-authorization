...
Conformance ledger (`conformance-manifest.json`): 672 requirement rows across 22 audited specs (197 tested, 70 partial, 402 todo, 3 blocked); 25 documents carry no rows in the audited set yet.
