...
Conformance ledger (`conformance-manifest.json`): 628 requirement rows across 20 audited specs (167 tested, 70 partial, 388 todo, 3 blocked); 26 documents carry no rows in the audited set yet.
