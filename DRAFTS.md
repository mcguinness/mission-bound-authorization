...
Conformance ledger (`conformance-manifest.json`): 707 requirement rows across 24 audited specs (195 tested, 72 partial, 437 todo, 3 blocked); 23 documents carry no rows in the audited set yet.
