...
Conformance ledger (`conformance-manifest.json`): 668 requirement rows across 22 audited specs (193 tested, 71 partial, 401 todo, 3 blocked); 25 documents carry no rows in the audited set yet.
