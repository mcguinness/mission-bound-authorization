...
Conformance ledger (`conformance-manifest.json`): 610 requirement rows across 19 audited specs (142 tested, 54 partial, 411 todo, 3 blocked); 25 documents carry no rows in the audited set yet.
