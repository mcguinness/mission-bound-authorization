...
Conformance ledger (`conformance-manifest.json`): 735 requirement rows across 24 audited specs (257 tested, 80 partial, 395 todo, 3 blocked); 23 documents carry no rows in the audited set yet.
