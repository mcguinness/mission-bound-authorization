...
Conformance ledger (`conformance-manifest.json`): 724 requirement rows across 24 audited specs (204 tested, 76 partial, 441 todo, 3 blocked); 23 documents carry no rows in the audited set yet.
