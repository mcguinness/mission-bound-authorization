...
Conformance ledger (`conformance-manifest.json`): 598 requirement rows across 18 audited specs (145 tested, 56 partial, 394 todo, 3 blocked); 26 documents carry no rows in the audited set yet.
