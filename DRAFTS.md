...
Conformance ledger (`conformance-manifest.json`): 660 requirement rows across 21 audited specs (181 tested, 71 partial, 405 todo, 3 blocked); 26 documents carry no rows in the audited set yet.
